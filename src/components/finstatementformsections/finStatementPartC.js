            ...
            <Form>
                ...
                <Row className="mb-3">
                  ...
                  <Col xs={3}>
                    <Toggle
                      ...
                      value={values.fs_partC_employed}
                      setValue={(value) => setFieldValue("fs_partC_employed", value)}
                    />
                  </Col>
                </Row>

                {values.fs_partC_employed && (
                  <>
                    <Row className="mb-3">
                      <Col>
                        <Input
                          name="fs_partC_employer_name"
                          label="5: What is the name of your employer?"
                          disabled={!values.fs_partC_employed}
                        />
                      </Col>
                    </Row>
                    <Row className="mb-3">
                      <Col>
                        <Input
                          name="fs_partC_employer_address"
                          label="6: What is the address of your employer?"
                          disabled={!values.fs_partC_employed}
                        />
                      </Col>
                    </Row>
                    <Row className="mb-3">
                      <Col>
                        <Input
                          name="fs_partC_employer_duration"
                          label="7: How long have you been at this place?"
                          disabled={!values.fs_partC_employed}
                        />
                      </Col>
                    </Row>
              ...
              <Row className="mb-3">
                ...
                <Col xs={3}>
                  <Toggle
                    className="float-right"
                    value={values.fs_partC_self_employed}
                    setValue={(value) => setFieldValue("fs_partC_self_employed", value)}
                  />
                </Col>
              </Row>

              <div className="subSection">
                {values.fs_partC_self_employed && (
                  <Row className="mb-3">
                    <Col>
                      <Input
                        name="fs_partC_self_employed_name"
                        label="What is the name of the business?"
                        disabled={!values.fs_partC_self_employed}
                      />
                    </Col>
                  </Row>
                )}
