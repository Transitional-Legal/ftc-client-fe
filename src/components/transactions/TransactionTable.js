...
const columnOrder = ["Created", "Type", "Description"];
...
const TransactionTable = ({ transactions = [], ...props }) => {
	...
	return <Table data={data} columnConfig={columnConfig} options={tableOptions} trClassName={formatRow} striped={false} {...props} />;
};
